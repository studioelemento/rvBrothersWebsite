        ...
        <div className="space-y-6">
            ...
            <div className="relative mb-10">
              ...
              <div className="flex justify-between relative z-10">
                <div className="flex flex-col items-center">
                  <div className="w-8 h-8 rounded-full bg-green-500 flex items-center justify-center text-white border-4 border-white mb-2">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-xs font-bold text-[#101b43]">Ready for Pickup</span>
                  <span className="text-[10px] text-slate-500 mt-0.5 text-center">May 27, 11:30 AM</span>
                </div>
                <div className="flex flex-col items-center">
                  <div className="w-8 h-8 rounded-full bg-green-500 flex items-center justify-center text-white border-4 border-white mb-2">
                    <svg width="14" height="10" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 5L5 9L13 1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                  </div>
                  <span className="text-xs font-bold text-[#101b43]">Shipped</span>
                  <span className="text-[10px] text-slate-500 mt-0.5 text-center">May 27, 03:45 PM</span>
                </div>
                <div className="flex flex-col items-center">
                  <div className="w-8 h-8 rounded-full bg-green-500 flex items-center justify-center text-white border-4 border-white mb-2 shadow-[0_0_0_4px_rgba(34,197,94,0.2)]">
                    <svg width="14" height="10" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 5L5 9L13 1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                  </div>
                  <span className="text-xs font-bold text-[#101b43]">Delivered</span>
                  <span className="text-[10px] text-slate-500 mt-0.5 text-center">May 29, 11:15 AM</span>
                </div>
              </div>
            </div>

            {/* Alert */}
            <div className="bg-green-50/50 border border-green-100 rounded-lg p-4 flex gap-3">
              <CheckCircle2 className="text-green-600 shrink-0 mt-0.5" size={18} />
              <div>
                <p className="text-sm font-bold text-green-800">Order has been delivered.</p>
                <p className="text-sm text-green-700 mt-0.5">Delivered on May 29, 2024 at 11:15 AM.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
            ...
            <div className="space-y-4 mb-6">
              <div>
                ...
                <input 
                  ...
                  value="Delhivery" 
                  readOnly 
                  className="w-full px-4 py-2 bg-white border border-slate-200 rounded-lg text-sm font-medium text-[#101b43] focus:outline-none"
                />
              </div>
              <div>
              ...
              <div>
                ...
                <div className="relative">
                  <input 
                    type="text" 
                    value="https://www.delhivery.com/track/12345678901234" 
                    readOnly 
                    className="w-full pl-4 pr-10 py-2 bg-white border border-slate-200 rounded-lg text-sm font-medium text-[#101b43] focus:outline-none truncate"
                  />
                  <a href="#" className="absolute right-3 top-1/2 -translate-y-1/2 text-indigo-500 hover:text-indigo-600 p-1 bg-indigo-50 rounded">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div>
                <span className="block text-xs font-semibold text-slate-500 mb-1">Shipped On</span>
                <span className="text-xs font-medium text-[#101b43]">May 27, 2024 at 03:45 PM</span>
              </div>
              <div>
                <span className="block text-xs font-semibold text-slate-500 mb-1">Delivered On</span>
                <span className="text-xs font-medium text-[#101b43]">May 29, 2024 at 11:15 AM</span>
              </div>
            </div>

            <div className="space-y-3">
              <button className="w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-indigo-200 bg-indigo-50 text-indigo-600 rounded-lg text-sm font-bold hover:bg-indigo-100 transition-colors">
              ...
              <button className="w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-slate-200 bg-white text-slate-400 rounded-lg text-sm font-bold cursor-not-allowed">
                Update Order Status
                <ChevronDown size={16} />
              </button>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
            ...
            <div className="relative pl-6 space-y-6">
              ...
              <div className="relative">
                <div className="absolute -left-6 w-5 h-5 bg-green-500 rounded-full flex items-center justify-center border-2 border-white text-white mt-0.5">
              ...
              <div className="relative">
                ...
                <div className="flex justify-between items-start">
                  <div>
                    <p className="text-sm font-bold text-[#101b43]">Ready for Pickup</p>
                  </div>
                  <span className="text-xs text-slate-500">May 27, 2024 at 11:30 AM</span>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="flex justify-between items-start">
                  <div>
                    <p className="text-sm font-bold text-[#101b43]">Shipped</p>
                  </div>
                  <span className="text-xs text-slate-500">May 27, 2024 at 03:45 PM</span>
                </div>
              </div>

              <div className="relative">
                <div className="absolute -left-6 w-5 h-5 bg-green-500 rounded-full flex items-center justify-center border-2 border-white text-white mt-0.5 shadow-[0_0_0_2px_rgba(34,197,94,0.2)]">
                  <svg width="10" height="8" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 4L3.5 6.5L9 1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                </div>
                <div className="flex justify-between items-start">
                  <div>
                    <p className="text-sm font-bold text-[#101b43]">Delivered</p>
                  </div>
                  <span className="text-xs text-slate-500">May 29, 2024 at 11:15 AM</span>
                </div>
              </div>
            </div>
          </div>
