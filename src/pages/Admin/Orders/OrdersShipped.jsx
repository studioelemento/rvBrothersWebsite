      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          <div className="flex items-center gap-4">
            ...
            <span className="inline-flex px-3 py-1 text-sm font-medium bg-blue-100 text-blue-700 rounded-md">
              Shipped
            </span>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
            ...
            <div className="relative mb-10">
              <div className="absolute top-4 left-4 right-4 h-0.5 bg-slate-200">
                <div className="absolute top-0 left-0 bottom-0 bg-green-500" style={{ width: '66%' }}></div>
              </div>
            ...
            <div className="bg-green-50/50 border border-green-100 rounded-lg p-4 flex gap-3">
              ...
              <div>
                <p className="text-sm font-bold text-green-800">Order has been shipped.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
            ...
            <div className="relative pl-6 space-y-6">
              <div className="absolute left-2.5 top-2 bottom-2 w-px bg-slate-100">
                 <div className="absolute top-0 left-0 bottom-0 bg-green-500" style={{ height: '66%' }}></div>
              </div>
              ...
              <div className="relative">
                <div className="absolute -left-6 w-5 h-5 bg-indigo-600 rounded-full flex items-center justify-center border-[3px] border-indigo-100 mt-0.5 shadow-[0_0_0_2px_rgba(99,102,241,0.2)]">
                </div>
                <div className="flex justify-between items-start">
                  <div>
