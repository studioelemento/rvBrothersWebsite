...
export default function OrdersPickup() {
  return (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
            ...
            <div className="relative mb-10">
              <div className="absolute top-4 left-4 right-4 h-0.5 bg-slate-200">
                <div className="absolute top-0 left-0 bottom-0 bg-green-500" style={{ width: '33%' }}></div>
              </div>
            ...
            <div className="bg-green-50/50 border border-green-100 rounded-lg p-4 flex gap-3">
              ...
              <div>
                <p className="text-sm font-bold text-green-800">Tracking details saved successfully.</p>
                <p className="text-sm text-green-700 mt-0.5">Order is marked as Ready for Pickup.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
            ...
            <div className="mb-6">
              <span className="block text-xs font-semibold text-slate-500 mb-1">Updated On</span>
              <span className="text-xs font-medium text-[#101b43]">May 27, 2024 at 11:30 AM</span>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
            ...
            <div className="relative pl-6 space-y-6">
              <div className="absolute left-2.5 top-2 bottom-2 w-px bg-slate-100">
                 <div className="absolute top-0 left-0 bottom-0 bg-green-500" style={{ height: '33%' }}></div>
              </div>
