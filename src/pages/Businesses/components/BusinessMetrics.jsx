...
export default function BusinessMetrics() {
  ...
  return (
    <div className="mt-16 sm:mt-24">
      <div className="relative overflow-hidden bg-white border border-slate-200/80 rounded-[28px] sm:rounded-[36px] p-8 sm:p-12 shadow-sm">
        ...
        <div className="flex flex-col items-center justify-center mb-12 sm:mb-16">
          <div className="flex items-center gap-6 w-full max-w-2xl justify-center">
            ...
            <span className="text-[10px] sm:text-xs font-semibold tracking-[0.35em] text-slate-500 uppercase text-center whitespace-nowrap">
            ...
            return (
              ...
              >
                ...
                {idx < metrics.length - 1 && (
                  <div className="hidden lg:block absolute right-[-4px] top-4 bottom-4 w-[1px] bg-slate-100" />
                )}

                {/* Icon inside styled circle */}
                <div className="relative flex items-center justify-center w-16 h-16 rounded-full border border-blue-100 bg-blue-50/50 text-blue-600 shadow-[0_0_15px_rgba(59,130,246,0.02)] transition-all duration-300 hover:scale-105 mb-5">
                ...
                {/* Blue separator */}
                <div className="w-7 h-[2px] bg-indigo-500 my-3.5" />

                {/* Description */}
                <p className="text-xs text-slate-650 leading-relaxed max-w-[170px]">
                  {metric.description}
                </p>
              </div>
            );
        ...
        <div className="absolute right-0 bottom-0 top-0 w-1/3 opacity-[0.03] pointer-events-none bg-[radial-gradient(#3b82f6_1.5px,transparent_1.5px)] [background-size:16px_16px]" />
      </div>
    </div>
  );
}
