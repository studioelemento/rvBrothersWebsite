        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col items-start text-left">
            ...
            <p className="text-slate-300 text-base sm:text-lg leading-relaxed max-w-xl mb-8">
              From collectibles and wellness products to industrial supplies and
              digital commerce, RV Brothers connects brands, products, and
              opportunities through a unified business ecosystem.
            </p>
            ...
            <div className="w-full bg-[#050b18]/60 backdrop-blur-md border border-slate-900/80 rounded-2xl p-6 grid grid-cols-2 sm:grid-cols-4 gap-6 relative shadow-inner">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-[10px] text-slate-400 font-medium uppercase leading-tight">
                    Trusted Since
                  </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-[10px] text-slate-400 font-medium uppercase leading-tight mt-1">
                    Happy Customers
                  </div>
                </div>
              </div>
