...
export default function About() {
  const features = [
    {
      ...
      description:
        "Years of consistent quality, reliability and customer satisfaction.",
    },
    {
      icon: ShoppingBag,
      title: "Diverse Product Portfolio",
      description:
        "From collectibles to industrial supplies, we serve multiple industries and needs.",
    },
    {
      icon: Handshake,
      title: "Strong Business Network",
      description:
        "A robust network of partners, vendors and distributors across India.",
    },
    {
      icon: Truck,
      title: "Pan India Delivery",
      description:
        "Efficient logistics and timely delivery to every corner of the country.",
    },
    {
      icon: Award,
      title: "Quality You Can Rely On",
      description:
        "Carefully sourced products that meet the highest quality standards.",
    },
    {
      icon: Headphones,
      title: "Customer First Approach",
      description:
        "Dedicated support and long-term relationships built on trust and transparency.",
    },
  ];
  ...
  return (
    <section
      id="about"
      className="w-full bg-[#020617] text-slate-100 py-16 sm:py-24 px-4 sm:px-6 lg:px-8 font-sans relative overflow-hidden border-t border-b border-slate-900/60"
    >
      {/* Background World Map Watermark Pattern */}
      <div className="absolute inset-0 opacity-[0.03] pointer-events-none flex items-center justify-center">
        <svg viewBox="0 0 1000 500" className="w-full h-full fill-slate-300">
          <path
            d="M150,150 Q250,80 350,150 T550,150 T750,150"
            fill="none"
            stroke="currentColor"
            strokeWidth="1"
            strokeDasharray="4,4"
          />
          <path
            d="M200,200 Q400,100 600,200 T900,200"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeDasharray="6,6"
      ...
      {/* Giant Stylized RV Logo Graphic Watermark (Top Right) */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <p className="text-center text-slate-400 text-sm sm:text-base max-w-3xl mx-auto mb-16 sm:mb-20 font-normal leading-relaxed">
          A legacy of trust, innovation and performance. We are committed to
          delivering quality products, building strong partnerships and creating
          value across every business we operate.
        </p>
