...
export default function Partner() {
  const opportunities = [
    {
      ...
      title: "Distributors",
      description:
        "Expand regional market presence through trusted distribution partnerships.",
    },
    {
      icon: ShoppingCart,
      title: "Retailers & Resellers",
      description:
        "Access curated products across multiple growing categories to sell in your market.",
    },
    {
      icon: Factory,
      title: "Manufacturers",
      description:
        "Present your products for distribution evaluation and explore market expansion opportunities.",
    },
    {
      icon: Building2,
      title: "Institutional Buyers",
      description:
        "Source reliable products with structured pricing, consistent supply and dedicated support.",
    },
  ];
  ...
  const leftHighlights = [
    {
      ...
      description:
        "Years of reliability and professional business relationships.",
    },
    {
      icon: MapPin,
    ...
    },
    {
      ...
      description:
        "We believe in growth that is built on trust and transparency.",
    },
  ];
  ...
  const handlePartnerAction = () => {
    window.location.href =
      "mailto:partner@rvbrothers.com?subject=Partnership%20Enquiry";
  };

  return (
    <section
      id="partner-section"
      className="w-full bg-[#020617] text-slate-100 py-16 sm:py-24 px-4 sm:px-6 lg:px-8 font-sans relative overflow-hidden border-b border-slate-900/60"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center mb-16">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            <p className="text-slate-300 text-sm sm:text-base leading-relaxed max-w-xl mb-8 font-normal">
              We collaborate with distributors, retailers, resellers,
              manufacturers and institutional buyers to expand market reach,
              strengthen product visibility and build long-term business
              relationships.
            </p>
