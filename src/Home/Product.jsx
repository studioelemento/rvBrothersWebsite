...
export default function Product() {
  ...
  const filteredProducts = activeTab === 'All Products'
    ? products
    : products.filter(p => p.category === activeTab || (activeTab === 'Accessories' && p.category === 'Industrial & Engineering'));
  ...
  return (
    <section id="shop" className="w-full bg-[#F8FAFC] py-16 sm:py-20 px-4 sm:px-6 lg:px-8 font-sans border-t border-b border-slate-200/60 relative">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-center text-slate-600 text-sm sm:text-base max-w-2xl mx-auto mb-10 font-normal leading-relaxed">
          Handpicked quality products from our diverse range of categories. <br className="hidden sm:block" />
            ...
            return (
              ...
              >
                ...
                <div className="p-4 flex-1 flex flex-col justify-between">
                  <div>
                    {/* Category Tag */}
                    <span className={`inline-block px-2.5 py-0.5 rounded-md text-[11px] font-semibold mb-2.5 ${product.categoryColor}`}>
                      {product.category}
                    </span>
          ...
          <div className="flex items-center gap-4 text-center sm:text-left z-10">
            ...
            <div>
              ...
              <p className="text-slate-400 text-xs sm:text-sm font-normal">
                Explore our full collection with 1000+ products across multiple categories.
              </p>
            </div>
          </div>
